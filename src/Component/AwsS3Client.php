...
class AwsS3Client
{
     ...
     * @param Redis|null $cacheHandler
     */
    public function __construct(string $version, string $region, string $bucket, string $imageCdn, ?Redis $cacheHandler = null)
    {
     ...
     * @param string $version
     *
     * @return \App\Component\AwsS3Client
     */
