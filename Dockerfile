...
RUN echo "ZGF0ZS50aW1lem9uZSA9IEF1c3RyYWxpYS9CcmlzYmFuZQpzZXNzaW9uLnNhdmVfaGFuZGxlciA9IHJlZGlzCnNlc3Npb24uc2F2ZV9wYXRoID0gInRjcDovL3JlZGlzOjYzNzki" | base64 --decode >> /usr/local/etc/php/conf.d/custom.ini && \
    # EDIT vhost
